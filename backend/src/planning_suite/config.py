...
NEW_PRODUCT_LAUNCH_SHEET_URL = os.getenv("NEW_PRODUCT_LAUNCH_SHEET_URL", "https://docs.google.com/spreadsheets/d/1pFn9ibv33BZPvU5LFRlJPJfTUMdLdBM52HEnFSc25O0/edit?usp=sharing").strip()
