...
from planning_suite.config import AUTH_COOKIE_DAYS, AUTH_COOKIE_NAME
from planning_suite.core.auth_tokens import sign_session_token, verify_session_token
from planning_suite.services.system_details import collect_system_details
...
def backfill_current_session_system_details(db) -> bool:
    ...
    from planning_suite.services.system_details import collect_system_details, inject_client_system_info_cookie
