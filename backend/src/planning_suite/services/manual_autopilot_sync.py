...
from planning_suite.config import DP_LOGICS_FOLDER, FF_MASTERS_XLSX, OUTPUT_PATH
...
def _probe_run_engine(db: Database) -> StepProbe:
    ...
    from planning_suite.services.pipeline_flow import _check_baseline_completed
