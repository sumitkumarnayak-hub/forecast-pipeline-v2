...
from planning_suite.core.dataframe import clean_sheet_df, sanitize_for_json
...
from planning_suite.services.validation_input import INPUT_TYPES
...
def get_validation_logics() -> dict[str, Any]:
    from planning_suite.core.validations.master_rules import (
        VALIDATION_VERSION,
        _EXCEL_ACTIVE_COLS,
        _EXCEL_CORE_COLS,
        _VALID_PLAN_DESIGNS,
...
def validate_master_by_id(master_id: str) -> dict[str, Any]:
    ...
    from planning_suite.services.validation_input import validate_input_dataframe
