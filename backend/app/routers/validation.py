...
def _record_run(
    *,
    ...
    from planning_suite.services.validation_history import append_validation_run
...
def validation_bootstrap(current_user: dict = Depends(get_current_user)):
    ...
    from planning_suite.services.validation_service import get_validation_bootstrap
...
def validation_logics(current_user: dict = Depends(get_current_user)):
    from planning_suite.services.validation_service import get_validation_logics
...
async def validate_input_upload(
    ...
    try:
        from planning_suite.services.validation_input import read_uploaded_table, validate_input_dataframe
...
def validate_master(
    ...
    try:
        from planning_suite.services.validation_service import validate_master_by_id
...
async def validate_baseline_output(
    ...
    try:
        import pandas as pd
        from planning_suite.services.output_validation import validate_baseline_summary_df
...
def validate_latest_baseline(current_user: dict = Depends(get_current_user)):
    from planning_suite.services.output_validation import find_latest_file, validate_baseline_output
...
def validate_latest_final_plan(current_user: dict = Depends(get_current_user)):
    from planning_suite.services.output_validation import find_latest_file, validate_final_plan_output
...
def validation_history(
    ...
    from planning_suite.services.validation_history import get_validation_history
...
def clear_validation_history(current_user: dict = Depends(require_write)):
    from planning_suite.services.validation_history import clear_validation_history
