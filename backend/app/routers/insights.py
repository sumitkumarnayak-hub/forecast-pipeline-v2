...
def insights_bootstrap(current_user: dict = Depends(get_current_user)):
    ...
    from planning_suite.services.insights_analytics import get_insights_bootstrap
...
def insights_view(
    ...
    from planning_suite.services.dashboard_analytics import list_available_weeks
    from planning_suite.services.insights_analytics import build_insights_view
...
def get_availability_loss(
    ...
    try:
        ...
        from planning_suite.services.insights_analytics import load_loss_sheet
...
def report_baseline_summary(
    ...
    from planning_suite.services.analytics_reports import get_baseline_summary_report
...
def report_plan_comparison(current_user: dict = Depends(get_current_user)):
    from planning_suite.services.analytics_reports import get_plan_comparison_report
...
def report_actual_vs_plan(
    ...
    from planning_suite.services.analytics_reports import get_actual_vs_plan_report
...
def report_downloads(current_user: dict = Depends(get_current_user)):
    from planning_suite.services.analytics_reports import list_downloadable_reports
