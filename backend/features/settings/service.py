...
from core.shared.email import RECIPIENT_CATEGORIES

from core.shared.system_details import collect_system_details_api, _server_details
...
def get_session_payload(
    *,
    ...
    if request_headers:
        from core.shared.system_details import _request_headers_details
