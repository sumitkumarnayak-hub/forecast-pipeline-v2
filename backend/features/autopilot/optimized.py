...
from core.shared.sheets_session import (
...
class OptimizedAutopilotRunner:
    ...
    def run(
        ...
        *,
        ...
        from features.autopilot.steps import execute_autopilot_step


        from core.storage.sync import sync_before_pipeline
        ...
        try:
            ...
            try:
                from core.storage.sync import sync_after_pipeline
