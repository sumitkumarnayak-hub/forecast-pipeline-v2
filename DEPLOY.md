...
|----------|--------|----------|
| `BACKEND_URL` | `https://sumitnayak210106-planning.hf.space` | **Yes** (recommended — also defaults in code if omitted) |
...
| Backend | https://sumitnayak210106-planning.hf.space |
...
Optional: set `BACKEND_URL=https://sumitnayak210106-planning.hf.space` in Vercel → Settings → Environment Variables (the app already defaults to this on Vercel if unset).
